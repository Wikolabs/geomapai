...
export const metadata: Metadata = {
  title: "GeoMapAI — Intelligence geospatiale pour decisions terrain",
  description: "GeoMapAI analyse vos territoires, optimise vos tournees et cartographie vos concurrents grace a l'IA. Donnees geospatiales actionnables pour logistique et commercial.",
};
